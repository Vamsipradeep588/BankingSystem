...
public class BankingSystem {
    public static void main(String[] args) {
        ...
        bank.addAccount("101", "Vamsi Yadav", 1000.0);
        bank.addAccount("102", "Rajiv Yadav", 1500.0);
        bank.addAccount("103", "Pradeeep Yadav",2000.0);

        // Performing transactions
        bank.performTransaction("101", 500.0);
        bank.performTransaction("102", 200.0);
        bank.performTransaction("103", 200.0);
        bank.performTransaction("104", 200.0);// This account doesn't exist
